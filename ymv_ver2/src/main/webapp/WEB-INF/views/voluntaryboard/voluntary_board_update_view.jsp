...
<input type="hidden" name="command" value="${requestScope.command }">
			...
			나이를 select or input text로 둘중에 뭐할지 정하기 --> <input type="radio"
				...
				<tr>
					...
					<td><input type="text" id="datepicker1" name="startDate"
						value="${requestScope.rvo.startDate}"> <select id="startTime"
						name="startTime">
							<!-- 한시간 단위로 하기 -->
				...
				<tr>
					...
					<td><input type="text" id="datepicker2" name="endDate" value="${requestScope.rvo.endDate}">
			...
			<input type="hidden" name="recruitNo" value="${requestScope.rvo.recruitNo }">
