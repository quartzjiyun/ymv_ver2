...
<form id="recruitForm" action="voluntary_board_update.ymv" method="post">

         <table class="content">
            <tr>
               <td>
               <b>글번호: <input type=text name=recruitNo value=${requestScope.rvo.recruitNo } readonly></input>
               | 타이틀:<input type=text name=title value=${requestScope.rvo.title }></input></b>
               </td></tr><tr>   <td>
                  <font size="2">분야 :
         ...
         <select id="location" name="location"> <!-- 지역(*도 별로) DB에서 받아오기 -->
          ...
          | 나이 제한 : <input type=text name=age 
